...
openssl req -new -key certs/grumpy-key.pem -subj "/CN=grumpy.default.apps.kewang-0113op1.qe.devcluster.openshift.com" -out grumpy.csr -config certs/grumpy_config.txt
